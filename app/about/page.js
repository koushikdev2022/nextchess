        ...
        <div className="max-w-6xl mx-auto lg:py-4 px-4 lg:px-0">
          <div className="lg:flex">
            ...
            <div className="lg:w-6/12 lg:pl-10">
              <h2 className="text-[#0B0B2C] text-xl lg:text-[40px] lg:leading-[50px] font-extrabold capitalize pb-4 ${plusJakartaSans.className}">Manabi Chouhan: <span className="text-[#52B69A]">Founder & CEO</span></h2>
